                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newJabatanModal"><i class="fas fa-plus mr-2"></i>Tambah Jabatan Baru</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($jabatan as $jb) : ?>
                                        <tr>
                                            ...
                                            <td><?= $jb['jabatan']; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/jabatanaccess/') . $jb['id_jabatan']; ?>" class="badge badge-warning">access</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="newJabatanModalLabel">Tambah Jabatan Baru</h5>
