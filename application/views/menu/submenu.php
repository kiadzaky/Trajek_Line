                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            ...
                            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal"><i class="fas fa-plus mr-2"></i>Tambah Submenu Baru</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($subMenu as $sm) : ?>
                                        <tr>
                                            ...
                                            <td><?= $sm['aktif']; ?></td>
                                            <td>
                                                <a class="badge badge-success" data-toggle="modal" data-target="#newSubMenuModalEdit">edit</a>
